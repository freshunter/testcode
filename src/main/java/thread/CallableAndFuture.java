    ...
    public static class MyCallableClass implements Callable<String>{
        ...
        public String call() throws Exception{   
            ...
            if (this.flag == 1){
                ...
                try {   
                    while (true) {   
                        System.out.println(flag + " looping.");   
                        Thread.sleep(2000);   
                    }   
                ...
                // falg不为0或者1,则抛出异常   
                throw new Exception(flag + " Bad flag value!");   
            }   
        }   
    }   
...
//            System.out.println(future2.getClass());
            Thread.sleep(5000);   
            try {
	        System.out.println("task2 status: " + future2.isDone());
	        System.out.println("task2 status: " + future2.get(4, TimeUnit.SECONDS));
            } catch (Exception e) {
        	e.printStackTrace();
            }
	    Thread.sleep(3000);     
